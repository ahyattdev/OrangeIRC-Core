#
#  Be sure to run `pod spec lint OrangeIRC.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
    IRC client framework written in Swift
                   DESC

s.homepage     = "https://ahyattdev.github.io/OrangeIRC"
  ...
  # s.social_media_url   = "http://twitter.com/Andrew Hyatt"
  ...
  s.source_files  = "OrangeIRC Core"
  s.exclude_files = "OrangeIRC iOS"
